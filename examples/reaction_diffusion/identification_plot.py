...
for _ in range(n_runs):
    ...
    errors["MF1"].append(np.mean(np.abs(y_hf_temp - y_mf1_temp)))
    errors["MF2"].append(np.mean(np.abs(y_hf_temp - y_mf2_temp)))
    errors["MF3"].append(np.mean(np.abs(y_hf_temp - y_mf3_temp)))
    errors["LF1"].append(np.mean(np.abs(y_hf_temp - y_lf1_temp)))
    errors["LF2"].append(np.mean(np.abs(y_hf_temp - y_lf2_temp)))
    errors["LF3"].append(np.mean(np.abs(y_hf_temp - y_lf3_temp)))
