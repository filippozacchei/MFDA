...
figure(1)
pcolor(x,y,u(:,:,j+1)); shading interp; colormap(jet); colorbar; drawnow; 
end

%%
save('reaction_diffusion_missing.mat','t','x','y','u','v')

%%
load reaction_diffusion_missing
