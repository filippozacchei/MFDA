...
def main():         
    ...
    mfnn_model.kfold_train([X_train_param, X_train_coarse1, X_train_coarse2, X_train_coarse3], y_train,[X_test_param,X_test_coarse1, X_test_coarse2, X_test_coarse3],y_test)
