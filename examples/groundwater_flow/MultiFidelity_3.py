...
def main():         
    ...
    mfnn_model.kfold_train([X_train_param,X_train_coarse3,X_train_coarse2,X_train_coarse1], y_train)
    
    # plot_results(X_test, y_test, mfnn_model.model)
    
    print("Test Error: ", np.mean((mfnn_model.model([X_test_param,X_test_coarse3,X_test_coarse2,X_test_coarse1])-y_test)**2))
